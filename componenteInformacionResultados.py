...
with open('./resultados_experimentaciones_finales_(III)/experimentacion_2/knowledge_table.json', 'r', encoding='utf-8') as file:
    data = json.load(file)
...
with open('./resultados_experimentaciones_finales_(III)/experimentacion_2/resultados.txt', 'w', encoding='utf-8') as result_file:
